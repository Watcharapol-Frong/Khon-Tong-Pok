...
const ROLES = [
  {
    ...
    desc: "เข้าสู่ระบบเพื่อดูผล Smart Profile ติดตามสถานะสมัครงาน และนัดสัมภาษณ์",
    href: "/login",
    cta: "เข้าสู่ระบบผู้สมัคร →",
  },
  {
    mascot: "/mascot/mascot-hero-company.png",
    label: "องค์กร / HR",
    desc: "เข้าสู่ระบบเพื่อดู Candidate ที่ Match จัดการตำแหน่งงาน และนัดสัมภาษณ์",
    href: "/company/login",
    cta: "เข้าสู่ระบบองค์กร →",
  },
];
        ...
        <div className="relative w-full max-w-[720px]">
          <div className="relative mb-10 text-center">
            ...
            <h1 className="text-[clamp(24px,4vw,32px)] font-extrabold tracking-[-0.03em]">
              เข้าสู่ระบบในฐานะไหน?
            </h1>
            <p className="mt-1.5 text-xs text-[#8A8A8A]">เลือกบทบาทของคุณเพื่อไปหน้าเข้าสู่ระบบที่ถูกต้อง</p>
          </div>
          ...
          {/* Same role ambiguity as the login cards above — can't send
              someone straight to /register (candidate) or /company/register
              (HR) without knowing which one they mean, so this also goes
              through a picker rather than a single link. */}
          <div className="mt-8 text-center text-xs text-[#8A8A8A]">
            ยังไม่มีบัญชี?{" "}
            <Link href="/register/select" className="font-extrabold text-[#0F0F0F] underline hover:opacity-80">
